...
public class TestCatalogDailyBilling extends TestIntegrationBase  {
    ...
    public void testDailyBillingNYTimezone() throws Exception {
        ...
        final UUID createdEntitlementId = entitlementApi.createBaseEntitlement(account.getId(), new DefaultEntitlementSpecifier(spec), account.getExternalKey(), null, null, false, true, ImmutableList.<PluginProperty>of(), callContext);
        ...
        try {
            ...
            invoiceUserApi.triggerInvoiceGeneration(account.getId(), targetDate, callContext);
        }
